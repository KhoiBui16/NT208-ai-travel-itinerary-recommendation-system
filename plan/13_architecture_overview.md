...
- **34 core endpoints** chia 6 nhóm: Auth (6 — bao gồm EP-31 forgot-password, EP-32 reset-password), Users (3), Itineraries (14 — bao gồm EP-34 claim), Places (7), Agent/Suggestion (5 — bao gồm EP-33 rate-limit, EP-35 chat-history). `EP-36 analytics` là optional/MVP2+.
