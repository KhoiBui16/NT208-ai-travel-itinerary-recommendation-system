...
├── tests/
│   ├── unit/                      # 194 unit tests collected (2026-07-16)
│   └── integration/               # 79 integration tests collected (2026-07-16)
├── alembic/
...
> **Current state (2026-07-16):** Phase C.1–C.4 đã merge hoàn chỉnh. Sau đó có các pass static image hardening, Goong map/activity coordinate support, và docs/video demo. Runtime DB vẫn là PostgreSQL + Alembic head `20260707_0016`; CSV root chỉ là snapshot/export artifact. Phần còn lại trước khi coi hệ thống "production-complete" là C.5 Analytics (optional) + data enrichment cho sparse cities.
