...
1. Tạo project mới trên Vercel, import repo.
...
5. Ghi lại:
   - production URL
   - preview URL pattern
6. Quay lại backend để set `FRONTEND_URL` và `CORS_ORIGINS`.

## 7. Render backend setup

### 7.1 Cấu hình web service
...
### 7.2 Vì sao ưu tiên native Python trước
...
### 7.3 Khi nào mới dùng Docker trên Render
