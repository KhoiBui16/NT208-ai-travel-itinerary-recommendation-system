...
```
feat/00051-c3-companion-chat        # companion chat REST API
feat/00052-c4-chat-history          # chat history API
docs/00050-c3-design-readiness-audit  # this branch (audit, no code)
```
