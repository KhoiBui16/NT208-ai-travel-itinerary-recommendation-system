...
Settings combine non-secret defaults from config.yaml with environment variables.
Local secrets belong in .env and must not be committed.
"""
...
def _flatten_config(prefix: str, value: Any, output: dict[str, Any]) -> None:
    """Flatten nested YAML keys into AppSettings field names."""
