...
Phân nhóm:
  1. Sub-schemas       — ExtraExpenseSchema, ActivitySchema, DaySchema, AccommodationSchema, TravelerInfo
  2. Request schemas   — GenerateItineraryRequest, CreateTripRequest, UpdateTripRequest, ClaimTripRequest
